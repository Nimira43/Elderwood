...
const words = [
  { text: 'Innovative', imgPath: '/images/words-images/ideas.svg' },
  { text: 'Cutting-edge', imgPath: '/images/words-images/concepts.svg' },
  { text: 'Elegant', imgPath: '/images/words-images/designs.svg' },
  { text: 'Code', imgPath: '/images/words-images/code.svg' },
  { text: 'Versatile', imgPath: '/images/words-images/ideas.svg' },
  { text: 'Seamless', imgPath: '/images/words-images/concepts.svg' },
  { text: 'User-focused', imgPath: '/images/words-images/designs.svg' },
  { text: 'Robust', imgPath: '/images/words-images/code.svg' }
]
